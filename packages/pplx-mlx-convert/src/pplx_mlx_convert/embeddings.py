...
Quantization = Literal["int8", "binary", "none"]
...
def load_embedder(model_path: Path | str, *, revision: str | None = None) -> ContextualEmbedder:
    return ContextualEmbedder(model_path, revision=revision)
